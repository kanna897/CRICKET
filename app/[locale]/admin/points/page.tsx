"use client";
/* eslint-disable @typescript-eslint/no-explicit-any -- points_table is present in the live schema but missing from the stale generated database types */
